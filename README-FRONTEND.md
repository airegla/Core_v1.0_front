...
- `ModuloCommissionSchedulesPage.jsx` — pagina del modulo "Horarios de comision" (adoptado de la tabla legacy "commission_schedules" por el nucleo de desarrollo): listado y alta contra la API del Core.
